...
<div class="form-group">
	<input type="checkbox" id="{{ $field['id'] }}"  name="{{ $field['name'] }}" value="1" data-toggle="checkbox-x" data-three-state="false" data-size="lg" @if ($field['value']) checked="checked" @endif  @if (!empty($field['readOnly'])) readonly @endif>
